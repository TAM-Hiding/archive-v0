...
def chunk_to_note_text(chunk: dict[str, Any], metadata: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"semantic_unit_page_start: {chunk.get('semantic_unit_page_start', '')}",
        f"semantic_unit_page_end: {chunk.get('semantic_unit_page_end', '')}",
        f"semantic_unit_char_count: {chunk.get('semantic_unit_char_count', '')}",
        f"semantic_unit_block_count: {chunk.get('semantic_unit_block_count', '')}",
