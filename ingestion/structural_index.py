...
def build_structural_index(chunks: list[dict[str, Any]], preview_chars: int = 220) -> list[dict[str, Any]]:
    ...
    for entry_index, chunk in enumerate(chunks):
        ...
        index_entries.append({
            ...
            "semantic_unit_page_start": chunk.get("semantic_unit_page_start"),
            "semantic_unit_page_end": chunk.get("semantic_unit_page_end"),
            "semantic_unit_char_count": chunk.get("semantic_unit_char_count"),
            "semantic_unit_block_count": chunk.get("semantic_unit_block_count"),
